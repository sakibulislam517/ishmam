...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      ...
      <header class="bg-white shadow-lg sticky top-0 z-50 header-with-float-logo">
    <div class="bg-accent-500 py-1 overflow-hidden">
      <div class="container mx-auto px-4">
        <div class="flex items-center justify-between text-xs">
          <div class="flex items-center space-x-6">
            <div class="flex items-center space-x-2 text-white">
              <i class="fa-solid fa-phone text-white w-4 h-4"></i>
              <span>01604016929</span>
            </div>
            <div class="flex items-center space-x-2 text-white">
              <i class="fa-regular fa-envelope text-white w-4 h-4"></i>
              <span>info@nahidsworld.com</span>
            </div>
          </div>
          <div class="hidden md:block">
            <div class="text-white font-medium">🎉 Free Delivery on Orders Above ৳1000</div>
          </div>
          <div class="flex items-center space-x-4 text-white">
            <a href="#" class="hover:text-gray-200 transition duration-300"><i class="fa-brands fa-facebook-f w-4 h-4"></i></a>
            <a href="#" class="hover:text-gray-200 transition duration-300"><i class="fa-brands fa-instagram w-4 h-4"></i></a>
            <a href="#" class="hover:text-gray-200 transition duration-300"><i class="fa-regular fa-comment w-4 h-4"></i></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-2 relative">
      <div class="flex items-center justify-between">
        <a href="{{ route('home') }}" class="logo-float hover:opacity-90 transition duration-300">
          <img src="https://nahidsworld.com/upload/logonahid.webp" alt="Nahids World" class="h-24 w-auto">
        </a>
        <div class="w-32"></div>

        <div class="hidden md:flex flex-1 max-w-xl mx-8">
          <div class="search-box w-full relative">
            <input type="text" id="searchInput" placeholder="Search for fresh fish, prawns, crabs..." class="search-input w-full px-3 py-2 pl-10 pr-3 border-2 border-gray-300 rounded-lg focus:border-primary-600 transition duration-300 text-sm" autocomplete="off">
            <i class="fa-solid fa-magnifying-glass absolute left-3 top-1/2 transform -translate-y-1/2 text-primary-600 w-4 h-4"></i>
            <div id="searchResults" class="search-panel absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-2xl max-h-96 overflow-y-auto z-50">
              <div id="searchResultsContent" class="p-2">
                <p class="px-3 py-2 text-xs font-semibold text-gray-500 border-b">Popular searches</p>
                <a href="{{ route('products') }}" class="block px-3 py-2 text-sm text-gray-700 hover:bg-primary-50 rounded-lg">Fresh fish</a>
                <a href="{{ route('products') }}" class="block px-3 py-2 text-sm text-gray-700 hover:bg-primary-50 rounded-lg">Prawns</a>
                <a href="{{ route('products') }}" class="block px-3 py-2 text-sm text-gray-700 hover:bg-primary-50 rounded-lg">Crabs</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-2">
          <div class="relative group">
            <button class="flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 p-1">
              <i class="fa-regular fa-user text-primary-600 w-4 h-4"></i>
              <div class="hidden sm:block">
                <div class="text-xs font-medium">Account</div>
              </div>
              <i class="fa-solid fa-chevron-down w-3 h-3 text-[10px]"></i>
            </button>
            <div class="absolute right-0 mt-2 w-48 bg-white border border-secondary-300 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
              <div class="py-2">
                <a href="{{ route('login') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-100 hover:text-primary-800">
                  <i class="fa-solid fa-right-to-bracket w-4 h-4 mr-2 inline"></i>Sign In
                </a>
                <a href="{{ route('signup') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-primary-100 hover:text-primary-800">
                  <i class="fa-solid fa-user-plus w-4 h-4 mr-2 inline"></i>Register
                </a>
              </div>
            </div>
          </div>

          <button type="button" class="open-side-cart relative flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 p-1" aria-label="Open shopping cart">
            <i class="fa-solid fa-cart-shopping text-primary-600 w-4 h-4"></i>
            <div class="hidden sm:block">
              <div class="text-xs font-medium" id="cart-total-display">৳0.00</div>
            </div>
            <span class="cart-badge absolute -top-1 -right-1 bg-secondary-600 text-white text-xs rounded-full h-4 w-4 flex items-center justify-center font-bold hidden" id="cart-count-display">0</span>
          </button>

          <div class="md:hidden">
            <button id="mobile-menu-btn" class="mobile-toggle text-primary-600 focus:outline-none p-2">
      ...
      <div class="md:hidden mt-2 pl-28">
        <div class="search-box relative">
          <input type="text" id="searchInputMobile" placeholder="Search for fresh fish..." class="search-input w-full px-3 py-2 pl-10 pr-3 border-2 border-gray-300 rounded-lg focus:border-primary-600 transition duration-300 text-sm" autocomplete="off">
          <i class="fa-solid fa-magnifying-glass absolute left-3 top-1/2 transform -translate-y-1/2 text-primary-600 w-4 h-4"></i>
          <div id="searchResultsMobile" class="search-panel absolute top-full left-0 right-0 mt-2 bg-white border border-gray-200 rounded-lg shadow-2xl max-h-96 overflow-y-auto z-50">
            <div id="searchResultsContentMobile"></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <nav class="bg-gray-50 py-2">
      <div class="container mx-auto px-4">
        <div class="hidden md:flex items-center justify-center space-x-6">
          <a href="{{ route('products') }}" class="flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 font-medium py-1 px-2 rounded-lg hover:bg-primary-50 text-sm">
            <i class="fa-solid fa-fish-fins text-primary-600 w-4 h-4"></i>
            <span>Fish &amp; Seafood</span>
          </a>
          <a href="{{ route('products') }}" class="flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 font-medium py-1 px-2 rounded-lg hover:bg-primary-50 text-sm">
            <i class="fa-solid fa-drumstick-bite text-primary-600 w-4 h-4"></i>
            <span>Meat Items</span>
          </a>
          <a href="{{ route('products') }}" class="flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 font-medium py-1 px-2 rounded-lg hover:bg-primary-50 text-sm">
            <i class="fa-solid fa-store text-primary-600 w-4 h-4"></i>
            <span>Our Store</span>
          </a>
          <a href="{{ route('products') }}" class="flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 font-medium py-1 px-2 rounded-lg hover:bg-primary-50 text-sm">
            <i class="fa-solid fa-gift text-primary-600 w-4 h-4"></i>
            <span>Super Packages</span>
          </a>
          <a href="{{ route('about-us') }}" class="flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 font-medium py-1 px-2 rounded-lg hover:bg-primary-50 text-sm">
            <i class="fa-regular fa-circle-question text-primary-600 w-4 h-4"></i>
            <span>About Us</span>
          </a>
          <a href="{{ route('contact-us') }}" class="flex items-center space-x-1 text-gray-700 hover:text-primary-600 transition duration-300 font-medium py-1 px-2 rounded-lg hover:bg-primary-50 text-sm">
            <i class="fa-regular fa-envelope text-primary-600 w-4 h-4"></i>
        ...
        <div id="mobile-menu" class="mobile-menu md:hidden">
          <div class="flex flex-col space-y-1 pt-2">
            <a href="{{ route('products') }}" class="flex items-center space-x-3 text-gray-700 hover:text-primary-600 transition duration-300 py-2 px-2 hover:bg-primary-50 rounded-lg text-sm">
              <i class="fa-solid fa-fish-fins text-primary-600 w-4 h-4"></i>
              <span>Fish &amp; Seafood</span>
            </a>
            <a href="{{ route('products') }}" class="flex items-center space-x-3 text-gray-700 hover:text-primary-600 transition duration-300 py-2 px-2 hover:bg-primary-50 rounded-lg text-sm">
            ...
            <a href="{{ route('about-us') }}" class="flex items-center space-x-3 text-gray-700 hover:text-primary-600 transition duration-300 py-2 px-2 hover:bg-primary-50 rounded-lg text-sm">
              <i class="fa-regular fa-circle-question text-primary-600 w-4 h-4"></i>
              <span>About Us</span>
            </a>
            <a href="{{ route('contact-us') }}" class="flex items-center space-x-3 text-gray-700 hover:text-primary-600 transition duration-300 py-2 px-2 hover:bg-primary-50 rounded-lg text-sm">
              <i class="fa-regular fa-envelope text-primary-600 w-4 h-4"></i>
              <span>Contact Us</span>
            </a>
          </div>
